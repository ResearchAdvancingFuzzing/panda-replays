...
docker build --no-cache -t panda-xmllint-3e7e75bed2cf2853b0d42d635d36676b3330d475-64bit-bug .
rm -rf install
mkdir install
docker run -v `pwd`/install:/install panda-xmllint-3e7e75bed2cf2853b0d42d635d36676b3330d475-64bit-bug cp -r libxml2 install
